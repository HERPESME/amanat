...
def run() -> None:
    ...
    print("  any duty to return the remainder after a partial debit, and the word")
    print("  \"release\" appears in neither. Left alone the money sits blocked until")
    print("  the customer-chosen end date — up to 90 days.")
    print("\n  So leg three of amount-contingent settlement is an ACTION this system")
    print("  must take, not a guarantee it inherits. And taking it is not free: a")
    print("  block is torn down by revoke, and OC-228 permits only one block at a")
    print("  time per merchant — so handing back the remainder may burn the standing")
    print("  mandate and force fresh authentication. Whether a decrease-without-revoke")
    print("  operation exists is UNVERIFIED and is the next thing to settle.\033[0m")
