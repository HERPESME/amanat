...
the rail's own state transitions. Claim exactly one thing as novel: that the evidence
...
| `panel-skeptic` | would this survive a hostile room? | **NO** as proposed |
...
│   └── panel-skeptic.md              would this survive a hostile room?
├── context/
...
5. **Volunteer the weaknesses before being asked** — §6 of the final recommendation. That is
